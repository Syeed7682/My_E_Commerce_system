		...
		<nav class="custom-navbar navbar navbar-expand-md navbar-dark sticky-top" arial-label="Furni navigation bar">
			<div class="container">
				<a class="navbar-brand" href="/client/index.php">
					<img style="height: 50px;" src="../images/logo.png" alt="EASY SHOP logo">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5 d-flex align-items-center">
						...
						<li class="me-3">
							...
							<a class="nav-link" href="/client/vendor/convert.php">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5 d-flex align-items-center">
						...
						<li class="me-3"><a class="nav-link" href="/client/login.php"><i class="fas fa-circle-plus fs-4 text-white"></i></a></li>
						<li class="me-3"><a class="nav-link" href="/client/login.php"><i class="fas fa-user fs-4 text-white"></i></a></li>
					</ul>
				</div>
			</div>
		</nav>
