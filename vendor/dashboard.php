                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0"><?php echo $totalShippedAmount; ?> BDT</span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0"><?php echo getVendorBalance($vendorName, $conn); ?> BDT</span>
                            </div>
                            <div class="col-auto">
